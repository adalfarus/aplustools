...
class SpecificPasswordGenerator:
    ...
    def __init__(
        self,
        random_generator: _ty.Literal["weak", "average", "strong"] | _ty.Any = "strong",
        debug: bool = False,
    ) -> None:
        if isinstance(random_generator, str):
            self._rng = _generator(
                {"weak": "random", "average": "np_random", "strong": "secrets"}[
                    random_generator
                ]
            )  # type: ignore
        else:
    ...
    def load_google_10000_dict(self) -> None:
        ...
        :return:
        """
        file_path = _files("aplustools.security.dicts").joinpath(
